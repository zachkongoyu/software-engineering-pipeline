# Edit Mode Prompt (Fbi)

A restricted agent mode built into VS Code Copilot that limits file access
to only the currently active file and explicitly attached files.
...
```jsonc
{
  ...
  "target": "vscode",
  "disableModelInvocation": true,   // model cannot invoke itself
  "userInvocable": true,
  "tools": ["read", "edit"],        // only read + edit tools available
  "agents": [],
  "handoffs": [
    {
